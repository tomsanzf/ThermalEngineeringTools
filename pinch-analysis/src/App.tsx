        ...
        <div className="flex items-center space-x-4">
          ...
          <div>
            <div className="flex flex-col">
              <span className="font-mono text-[10px] font-extrabold tracking-[0.2em] text-cyan-400 uppercase leading-none mb-1">
                Armstrong International
              </span>
              <h1 className="text-xl font-bold tracking-tight text-white leading-tight">Pinch Analysis Tool</h1>
            </div>
